...
export default function SideNavigation() {
  ...
  return (
    <div className="sticky top-0 w-16 h-screen overflow-y-auto border-r md:w-24 shrink-0 no-scrollbar border-slate-200 dark:border-slate-800">
      <div className="flex flex-col justify-between h-full after:flex-1 after:mt-auto">
