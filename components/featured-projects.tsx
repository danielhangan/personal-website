export default function FaeturedProjects() {
  return (
    <section>
      <h2 className="font-aspekta text-xl font-[650] mb-5">Featured Projects</h2>

      {/* Cards */}
      <div className="grid gap-5 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2">
        <a
          className="p-5 transition-transform duration-700 ease-in-out border rounded-lg border-slate-200 dark:border-slate-800 dark:bg-gradient-to-t dark:from-slate-800 dark:to-slate-800/30 odd:-rotate-1 even:rotate-1 hover:rotate-0 hover:duration-100"
          href="https://tryinterlinked.com/"
        >
          <div className="flex flex-col h-full">
            <div className="grow">
              <div className="flex items-center justify-center w-10 h-10 mb-2 border rounded-full border-slate-200 dark:border-slate-700">
              ...
              <div className="text-lg font-aspekta font-[650] mb-1">Interlinked</div>
              <p className="mb-2 text-sm text-slate-500 dark:text-slate-400">Data-Driven deal sourcing platform for VCs</p>
            </div>
        ...
        >
          <div className="flex flex-col h-full">
            <div className="grow">
              ...
              <div className="text-lg font-aspekta font-[650] mb-1">PulseView</div>
              <p className="mb-2 text-sm text-slate-500 dark:text-slate-400">Real-time people data</p>
            </div>
            <div className="flex justify-end text-sky-500">
              <svg className="fill-current" xmlns="http://www.w3.org/2000/svg" width="14" height="12">
                <path d="M9.586 5 6.293 1.707 7.707.293 13.414 6l-5.707 5.707-1.414-1.414L9.586 7H0V5h9.586Z" />
