...
import HagueImg from '@/public/images/hague.jpeg'
    ...
    <div className="space-y-8">
      ...
      <ul className="space-y-8">
        ...
        <li className="relative group">
          <div className="flex items-start before:absolute before:left-0 before:h-full before:w-px before:bg-slate-200 before:dark:bg-slate-800 before:self-start before:ml-[28px] before:-translate-x-1/2 before:translate-y-8 before:group-last-of-type:hidden">
            <div className="absolute left-0 flex items-center justify-center bg-white border rounded-full h-14 w-14 border-slate-200 dark:border-slate-800 dark:bg-gradient-to-t dark:from-slate-800 dark:to-slate-800/30 dark:bg-slate-900">
              <Image src={HagueImg} width={24} height={26} alt="Hague University" />
            </div>
            <div className="pl-20 space-y-1">
              <div className="text-xs uppercase text-slate-500">May 2013 <span className="text-slate-400 dark:text-slate-600">·</span> Apr 2017</div>
              <div className="font-aspekta font-[650] text-slate-800 dark:text-slate-100">Bachelor's Degree, International Business and Management Studies</div>
              <div className="text-sm font-medium text-slate-800 dark:text-slate-100">The Hague University of Applied Sciences</div>
              <div className="text-sm text-slate-500 dark:text-slate-400">While studying, I started and build Hague Investment and Trading Society. Minored in Finance.</div>
            </div>
          </div>
        </li>
      </ul>
